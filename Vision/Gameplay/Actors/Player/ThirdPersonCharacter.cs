...
public class ThirdPersonCharacter : MonoBehaviour
{
	...
	public void TakeDamage(int Damage, string DamageType = "world")
	{
		if (blockInput)
		{
			//print("Blocked");
    ...
    public void Move(Vector3 move, bool block, bool jump, Vector3 lookPos)
    {
    ...
    private void HandleGroundedVelocities()
    {
        ...
        if (jumpInput && !blockInput && okToRepeatJump && animationGrounded)
        {
            // jump!
            onGround = false;
    ...
    private void UpdateAnimator()
    {
        ...
        //animator.SetBool("Block", blockInput);
